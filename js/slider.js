...
(function($) {
	...
	$.fn.easySlider = function(options){
		...
		this.each(function() {  
			var obj = $(this); 	
			var thisli = options.classoflist;	
			if (options.classoflist) {
				var s = $("li."+thisli, obj).length;
			}
			else {
				var s = $("li", obj).length;
			}
			...
			if(options.controlsShow){
				...
				if(options.numeric){
					html += '<div class="parent"><span><ol id="'+ options.numericId +'"></ol></span></div>';
				} else {
			...
			if(options.numeric){									
				...
				$(obj).nextUntil("a","."+options.nextId).click(function(){		
					animate("next",true);
				});
				$(obj).nextUntil("a","."+options.prevId).click(function(){		
					animate("prev",true);				
				});	
				$(obj).nextUntil("a","."+options.firstId).click(function(){		
					animate("first",true);
				});				
				$(obj).nextUntil("a","."+options.lastId).click(function(){		
					animate("last",true);				
				});				
			};
